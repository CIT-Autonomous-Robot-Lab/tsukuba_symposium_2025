...
本チームでは, ナビゲーションに自作したkinako\_nav\cite{kinako_nav_github}を採用し,
その中核としてFast Marching Method (FMM) に基づくvector\_field\_plannerを開発した.
当初はnavigation2\cite{nav2}を採用し, グローバルプランナーにA*, ローカルプランナーにDWBを用いたが,
