...
\subsubsection{開発した経路計画手法}
本チームは,経路計画に自作したvector\_field\_plannerを採用した.
当初, navigation2のグローバルプランナーにA*、ローカルプランナーにDWBを採用していたが,
...
これらの課題を解決するため,
Fast Marching Method (FMM) を用いた経路計画手法を開発した.
本システムは,
