...
各チームともアールティ社製のRaspberry Pi Cat\cite{RTshop}を改造したロボットを使用した（図\ref{fig:robot}）。
視認性と緊急時の持ち上げ易さを考慮し、すべてのロボットに取手を追加している。
また、むぎまるときなこチームはフレームを大型化し、メンテナンス性と搭載量を向上させた。
この改造により, 
...
本年度は, 新たにロボットのフレームを拡張してメンテナンス性と積載量を向上させるとともに,
