...
きなこチームは,
ベクトル量子化により, 3次元占有格子地図を圧縮し, 
それを用いて自己位置推定するパッケージを開発した. 
地図を圧縮した結果, 圧縮率$0.0024$を達成した. 
また, ポテンシャル場を用いたナビゲーションパッケージを開発した. 
本走行では, 開発したパッケージと圧縮後の地図で
ナビゲーションができることを確認したが, 
ウェイポイントの置き忘れにより, 
一時停止すべき位置で停止できずリタイアとなった. 
